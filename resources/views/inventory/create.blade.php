    ...
    <form action="{{ route('inventory.store') }}" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <select name="model_type_id" required
          ...
          @foreach($modelTypes as $mt)
            <option value="{{ $mt->id }}" {{ old('model_type_id') == $mt->id ? 'selected' : '' }}>
      ...
      <div class="flex gap-4">
        <div class="flex-1">
          ...
          <input name="stock_quantity" type="number" min="0" value="{{ old('stock_quantity') }}"
      ...
      <div class="flex gap-4">
        <div class="flex-1">
          ...
          <input name="inventory_in_date" type="date" value="{{ old('inventory_in_date') }}"
                 class="w-full px-4 py-2 rounded-lg bg-gray-900 text-white border border-gray-700 focus:ring-2 focus:ring-blue-500" />
        ...
        <div class="flex-1">
          ...
          <input name="inventory_out_date" type="date" value="{{ old('inventory_out_date') }}"
                 class="w-full px-4 py-2 rounded-lg bg-gray-900 text-white border border-gray-700 focus:ring-2 focus:ring-blue-500" />
