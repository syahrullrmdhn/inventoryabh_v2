  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
      <div>
        ...
        <p class="text-gray-400 mt-1">Manage all your warehouse locations and information</p>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-700">
          <thead class="bg-gray-700">
            <tr>
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Warehouse Name</th>
          ...
          <tbody class="bg-gray-800 divide-y divide-gray-700">
            ...
            <tr class="hover:bg-gray-700/40 transition-colors">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-300">{{ $warehouse->location }}</div>
              </td>
