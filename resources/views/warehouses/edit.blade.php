  ...
  <div class="bg-gray-800/60 rounded-2xl p-8 mt-10">
    ...
    <form action="{{ route('warehouses.update', $warehouse) }}" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <input name="location" value="{{ old('location', $warehouse->location) }}"
